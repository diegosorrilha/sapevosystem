# Generated by Django 2.1 on 2018-11-18 02:18
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('peso', models.CharField(choices=[(3, 'Absolutamente Melhor'), (2, 'Muito Melhor'), (1, 'Melhor'), (0, 'Igual / Equivalente'), (-1, 'Pior'), (-2, 'Muito Pior'), (3, 'Absolutamente Pior')], default=3, max_length=5)),
